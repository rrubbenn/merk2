    ...
    <div class="row mt-5">
        ...
        <div class="col-2 d-flex flex-column border-end">
            <div class="p-3">
                ...
                <a href="<?php echo RUTA_URL?>/productos/ventas/<?php echo $datos['usuarioSesion']->id_usuario ?>" class="text-decoration-none text-dark"> <div class="mt-3"> <h4> <b> Ventas </b> </h4> </div> </a>
            </div>
        </div>
        <div class="col-9">
