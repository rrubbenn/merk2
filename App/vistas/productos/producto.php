        ...
        <div class="d-flex">
            ...
            <div class="col-1 text-end">
                <?php if( $datos['esFavorito']->esFavorito == 'false'): ?>
                    <button onclick="marcardesmarcarFavorito(<?php echo RUTA_URL ?>, <?php echo $datos['esFavorito']->esFavorito ?>, <?php echo $datos['producto']->id_producto ?>)" class="btn btn-light fs-5"> 
